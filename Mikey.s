...
timrDoRel:
	...
	andne r1,r2,#0xFF00
	addne r1,r1,#0x0100
	addne r2,r2,r1,lsl#16
	addne r6,r6,r1,lsr#8
...
timrNoCount:
	...
	addne r1,r4,#1
	addeq r1,r6,#1
	addeq r1,r4,r1,lsl r3
	//if (gNextTimerEvent > tmp) {
	//	gNextTimerEvent = tmp;
	//}
	cmp r5,r1
	movpl r5,r1
